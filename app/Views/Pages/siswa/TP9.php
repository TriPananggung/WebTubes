...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary" id="navbarr">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <b><a class="nav-link text-white" href="#"><i class="fa fa-bell-o"></i> [Notification]</a></b>
                </li>
                <li class="nav-item">
    ...
    <div class="col-md-2 bg-primary mt-2 pr-3 pt-4">
        <ul class="nav flex-column ml-3 mb-5">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white" href="#"><i class="fas fa-home"></i> Home</a><hr class="bg-secondary">
            </li>
            <li class="nav-item ">
...
<div class="col-md-10 p-5 pt-2">
        <h3><i class="fa fa-bell-o"></i><b> Notification/</b>Pemberitahuan</h3><hr><!--jangan lupa-->
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="card-link">Ingatkan kembali</a>
                    </div>
                    </div>
                </div>
            </div></br>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="card-link">Lewati</a>
                    </div>
                    </div>
                </div>
            </div></br>
